...
public class PcJFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cbStatus.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Disponível", "Ocupado", "Manutenção", "Reservado" }));
...
public class PcJFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
       ...
       if (txtPcId.getText().trim().isEmpty()) {
           JOptionPane.showMessageDialog(this, "Informe o ID do computador.");
       ...
       try {
          ...
          Computador computador = new Computador();
           ...
           computador.setId(Integer.parseInt(txtPcId.getText()));
           computador.setStatus(cbStatus.getSelectedItem().toString());
    ...
    private void btnTotalPcActionPerformed(java.awt.event.ActionEvent evt) {                                           
        try {
